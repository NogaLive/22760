...
const DashboardGrado = () => {
  ...
  return (
    <>
      <div className="animate-fade-in">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex gap-2">
            <button className="btn btn-secondary flex items-center gap-1 bg-gray-200 border-gray-300 text-gray-800" onClick={() => setModalJustificacionesListaOpen(true)}>
              <FileText size={16} /> Ver Justificaciones 
            </button>
            <button className="btn btn-secondary flex items-center gap-1 bg-gray-200 border-gray-300 text-gray-800" onClick={() => setModalJustificacionOpen(true)}>
              <Plus size={16} /> Registrar Justificación
            </button>
          </div>
        </div>
      </div>
      ...
      {/* KPIs */}
      <div className="grid gap-4 mb-6" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))' }}>
        ...
        <div className="card" style={{ height: '470px', display: 'flex', flexDirection: 'column', padding: 0 }}>
          <div className="flex justify-between items-center" style={{ padding: '1.5rem' }}>
            ...
            <div className="flex gap-2">
              ...
              />
              <button 
                className="btn btn-secondary flex items-center gap-1 opacity-90 hover:opacity-100" 
                style={{ padding: '0.25rem 0.75rem', fontSize: '0.75rem', backgroundColor: '#f3f4f6', color: '#4b5563', borderColor: '#d1d5db' }}
              ...
              <button 
                className="btn btn-secondary flex items-center gap-1 opacity-90 hover:opacity-100" 
                style={{ padding: '0.25rem 0.75rem', fontSize: '0.75rem', backgroundColor: '#e8f5e9', color: '#2e7d32', borderColor: '#c8e6c9' }}
                onClick={() => document.getElementById('excel-upload').click()}
                disabled={isImporting}
              >
                <FileDown size={14} /> {isImporting ? 'Importando...' : 'Importar Excel'}
              </button>
              
              <button 
                className="btn btn-secondary flex items-center gap-1 opacity-90 hover:opacity-100" 
                style={{ padding: '0.25rem 0.75rem', fontSize: '0.75rem', backgroundColor: '#e3f2fd', color: '#1565c0', borderColor: '#bbdefb' }}
                onClick={handleGenerateCredenciales}
                disabled={isGeneratingPdf}
              >
                <QrCode size={14} /> {isGeneratingPdf ? 'Generando PDF...' : 'Generar Carnets'}
              </button>
